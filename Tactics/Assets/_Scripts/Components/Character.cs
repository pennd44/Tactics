...
public class Character : MonoBehaviour
{
    ...
    // public event System.Action<Tile> OnTurnEnd;
    public void OnTurnEnd()
    {
        // Debug.Log(this.name + "on turn end");

        List<Tile> neighboringTiles = currentTile.GetNeighbors();
    ...
    {
        // battleStateMachine.StopCoroutine();
        // battleStateMachine.StartCoroutine(mover.currentMovement.ITurn(target.transform.position));
        ...
        yield return mover.currentMovement.ITurn(target.transform.position);
        // ability.OverrideAnimation(unitAnimator);
